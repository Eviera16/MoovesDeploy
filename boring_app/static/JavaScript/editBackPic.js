$(document).ready(function(){
    ...
    if (fontType == 1){
        ...
        $("#header").find(".subBackPic").css("font-family", "-apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Oxygen, Ubuntu, Cantarell, 'Open Sans', 'Helvetica Neue', sans-serif")
    }
    if (fontType == 2){
        ...
        $("#header").find(".subBackPic").css("font-family", "cursive")
    }
    if (fontType == 3){
        ...
        $("#header").find(".subBackPic").css("font-family", "fantasy")
    }
    if (fontType == 4){
        ...
        $("#header").find(".subBackPic").css("font-family", "monospace")
    }
    if (fontType == 5){
        ...
        $("#header").find(".subBackPic").css("font-family", "sans-serif")
    }
    if (fontType == 6){
        ...
        $("#header").find(".subBackPic").css("font-family", "'Franklin Gothic Medium', 'Arial Narrow', Arial, sans-serif")
    }
    ...
    if(fontSize == 1){
        ...
        $("#header").find(".subBackPic").css("font-size", "15px")
    }
    if(fontSize == 2){
        ...
        $("#header").find(".subBackPic").css("font-size", "20px")
    }
    if(fontSize == 3){
        ...
        $("#header").find(".subBackPic").css("font-size", "30px")
    }
    ...
    if (fontColor == 1){
        if (background == 1){
            ...
            $("#header").find(".subBackPic").css("color", "black")
        }
        else{
            ...
            $("#header").find(".subBackPic").css("color", "white")
        }
    }
    if (fontColor == 2){
        ...
        $("#header").find(".subBackPic").css("color", "blue")
    }
    if (fontColor == 3){
        ...
        $("#header").find(".subBackPic").css("color", "red")
    }
    if (fontColor == 4){
        ...
        $("#header").find(".subBackPic").css("color", "green")
    }
    if (fontColor == 5){
        ...
        $("#header").find(".subBackPic").css("color", "orange")
    }
    if (fontColor == 6){
        ...
        $("#header").find(".subBackPic").css("color", "purple")
    }
    if (fontColor == 7){
        ...
        $("#header").find(".subBackPic").css("color", "pink")
    }
